...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-x-clip pt-20 sm:pt-28 pb-12 sm:pb-20 bg-[#030507] text-white border-b border-white/10">
      {/* High-End Ambient Background Gradients & Grid */}
      <div className="absolute inset-0 dark-grid-bg opacity-25 pointer-events-none" aria-hidden="true" />

      {/* Top Ambient Glow Orb */}
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-brand-teal/10 rounded-full blur-[140px] pointer-events-none"
        aria-hidden="true"
      />

      {/* Hero Typography (Centered Content Container) */}
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center mb-6 sm:mb-10">
      ...
      */}
      <HeroHandsVisual>
        <a
          ...
          className="group relative inline-flex items-center gap-3.5 px-8 sm:px-11 py-3.5 sm:py-4 text-base sm:text-lg font-bold text-brand-dark bg-brand-teal rounded-full shadow-[0_0_35px_rgba(132,192,191,0.55),0_0_70px_rgba(132,192,191,0.25)] hover:bg-[#9de1e0] hover:shadow-[0_0_50px_rgba(132,192,191,0.8),0_0_90px_rgba(132,192,191,0.4)] hover:scale-[1.03] active:scale-[0.98] transition-all duration-300 whitespace-nowrap cursor-pointer"
        >
          <IconBrandDiscord
            size={24}
            stroke={2.2}
